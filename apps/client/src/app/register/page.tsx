                ...
                <div className="flex flex-col gap-10 relative">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-[#4A5580] text-sm leading-relaxed max-w-[300px]">
                            Set up your workspace in seconds. Invite your team and start shipping
                            faster.
                        </p>
                    </div>
                    ...
                    <ul className="flex flex-col gap-5">
                        {[
                            { step: "01", label: "Create your workspace", done: true },
                            { step: "02", label: "Invite your teammates", done: false },
                            { step: "03", label: "Start your first project", done: false },
                        ].map((item) => (
                            <li key={item.step} className="flex items-center gap-4">
                                ...
                                <span
                                    className={`text-sm ${item.done ? "text-white font-medium" : "text-[#4A5580]"}`}
                                >
                                    {item.label}
                                </span>
                            </li>
                    ...
                    <div className="flex gap-8">
                        {[
                            { num: "2.4M", label: "Tasks shipped" },
                            { num: "98k", label: "Teams worldwide" },
